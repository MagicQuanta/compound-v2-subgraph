...
export class PriceOracle2 extends ethereum.SmartContract {
  ...
  makerUsdOracleKey(): Address {
    let result = super.call('makerUsdOracleKey', 'makerUsdOracleKey():(address)', [])

    return result[0].toAddress()
  }

  try_makerUsdOracleKey(): ethereum.CallResult<Address> {
    let result = super.tryCall('makerUsdOracleKey', 'makerUsdOracleKey():(address)', [])
    if (result.reverted) {
      return new ethereum.CallResult()
    }
    let value = result.value
  ...
  try_v1PriceOracle(): ethereum.CallResult<Address> {
    let result = super.tryCall('v1PriceOracle', 'v1PriceOracle():(address)', [])
    if (result.reverted) {
      return new ethereum.CallResult()
    }
    let value = result.value
