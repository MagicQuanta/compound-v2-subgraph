...
export class Comptroller extends ethereum.SmartContract {
  ...
  _setPendingAdmin(newPendingAdmin: Address): BigInt {
    let result = super.call('_setPendingAdmin', '_setPendingAdmin(address):(uint256)', [
  ...
  markets(param0: Address): Comptroller__marketsResult {
    ...
    return new Comptroller__marketsResult(result[0].toBoolean(), result[1].toBigInt())
  }
  ...
  try_checkMembership(account: Address, cToken: Address): ethereum.CallResult<boolean> {
    let result = super.tryCall(
      'checkMembership',
      'checkMembership(address,address):(bool)',
      [ethereum.Value.fromAddress(account), ethereum.Value.fromAddress(cToken)],
  ...
  try_enterMarkets(cTokens: Array<Address>): ethereum.CallResult<Array<BigInt>> {
  ...
  _setMaxAssets(newMaxAssets: BigInt): BigInt {
    let result = super.call('_setMaxAssets', '_setMaxAssets(uint256):(uint256)', [
  ...
  try__setMaxAssets(newMaxAssets: BigInt): ethereum.CallResult<BigInt> {
    let result = super.tryCall('_setMaxAssets', '_setMaxAssets(uint256):(uint256)', [
      ethereum.Value.fromUnsignedBigInt(newMaxAssets),
    ])
    if (result.reverted) {
      return new ethereum.CallResult()
  ...
  borrowAllowed(cToken: Address, borrower: Address, borrowAmount: BigInt): BigInt {
    let result = super.call(
      'borrowAllowed',
  ...
  _setCollateralFactor(cToken: Address, newCollateralFactorMantissa: BigInt): BigInt {
    let result = super.call(
  ...
  redeemAllowed(cToken: Address, redeemer: Address, redeemTokens: BigInt): BigInt {
    let result = super.call(
      'redeemAllowed',
